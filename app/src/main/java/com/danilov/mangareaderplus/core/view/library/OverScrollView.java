package com.danilov.mangareaderplus.core.view.library;
...
public class OverScrollView extends FrameLayout implements OnTouchListener
{
    ...
    {
        child = getChildAt(0);
        child.setPadding(child.getPaddingLeft(), child.getPaddingTop(), child.getPaddingRight(), 1500);
        ...
        switch (action & MotionEvent.ACTION_MASK)
        {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged)
                {
                    ...
                    velocityTracker.computeCurrentVelocity(3000, mMaximumVelocity);
