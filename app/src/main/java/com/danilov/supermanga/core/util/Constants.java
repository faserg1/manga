...
public class Constants {
    ...
    public static class Settings {
        ...
        public static final String USE_VOLUME_BUTTONS = "USE_VOLUME_BUTTONS";

        public static final String[] ALL_SETTINGS = {USER_NAME, EMAIL, TIME_READ, MANGA_DOWNLOAD_PATH, MANGA_FINISHED, BYTES_DOWNLOADED, ALWAYS_SHOW_VIEWER_BUTTONS, TUTORIAL_VIEWER_PASSED, USE_VOLUME_BUTTONS};
