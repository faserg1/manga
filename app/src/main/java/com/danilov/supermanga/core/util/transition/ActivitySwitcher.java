package com.danilov.supermanga.core.util.transition;
...
public class ActivitySwitcher {
    ...
    public static void animationInBack(View container, WindowManager windowManager) {
        apply3DRotation(-90, 0, false, container, windowManager, null);
    }

    public static void animationOutBack(View container,
                                    WindowManager windowManager, AnimationFinishedListener listener) {
        apply3DRotation(0, 90, true, container, windowManager, listener);
    }
