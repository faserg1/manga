...
<script type="text/javascript">
  ...
  (function(){
    ...
    b(function(){
      ...
      setTimeout(function(){
        var s,t,o,p,b,r,e,a,k,i,n,g,f, zHTipgF={"hmjEBXg":+((+!![]+[])+(!+[]+!![]+!![]))};
        ...
        ;zHTipgF.hmjEBXg-=+((+!![]+[])+(!+[]+!![]));zHTipgF.hmjEBXg+=+((+!![]+[])+(+!![]));zHTipgF.hmjEBXg+=+((+!![]+[])+(+[]));zHTipgF.hmjEBXg-=+((!+[]+!![]+!![]+[])+(!+[]+!![]+!![]+!![]));zHTipgF.hmjEBXg*=+((!+[]+!![]+[])+(+[]));zHTipgF.hmjEBXg-=+((+!![]+[])+(!+[]+!![]+!![]+!![]+!![]+!![]+!![]+!![]));zHTipgF.hmjEBXg+=+((+!![]+[])+(!+[]+!![]+!![]+!![]+!![]+!![]+!![]));zHTipgF.hmjEBXg+=+((!+[]+!![]+[])+(!+[]+!![]+!![]));zHTipgF.hmjEBXg-=+((!+[]+!![]+[])+(!+[]+!![]+!![]+!![]));zHTipgF.hmjEBXg*=+((!+[]+!![]+[])+(!+[]+!![]+!![]+!![]+!![]+!![]+!![]+!![]));a.value = parseInt(zHTipgF.hmjEBXg, 10) + t.length;
        f.submit();
      }, 4000);
    }, false);
  })();
...
<div class="cf-browser-verification cf-im-under-attack">
  ...
  <form id="challenge-form" action="/cdn-cgi/l/chk_jschl" method="get">
    <input type="hidden" name="jschl_vc" value="72a21b9b2adb5a024594368c5d9dbb40"/>
    <input type="hidden" name="pass" value="1465028966.696-iQc6Gavg4L"/>
